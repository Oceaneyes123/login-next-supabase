...
export default function GlassShell({ title, subtitle, children }) {
  ...
  /* slightly reduced vertical padding to make inputs a bit shorter */
  .form-input { width: 100%; padding: 12px 18px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 16px; color: rgba(255,255,255,0.9); font-size: 16px; font-weight: 300; transition: all 0.3s ease; backdrop-filter: blur(10px); outline: none; }
        ...
        /* utility: bottom margin for form rows (keeps consistent spacing) */
  ...
  @media (max-width:480px) { .login-card { width:90%; padding:32px 24px; margin:20px auto; } .login-title { font-size:28px; } }
      `}</style>
